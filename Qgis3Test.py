...
class Qgis3Test:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Qgis3Test', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Qgis3Test/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            self.dlg.done(0)
            self.dlg.PBRunWait.clicked.disconnect()
            self.dlg.PBStopWait.clicked.disconnect()
            self.dlg.PBRunCounter.clicked.disconnect()
